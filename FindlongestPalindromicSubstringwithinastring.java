...
public class FindlongestPalindromicSubstringwithinastring {
    private static void printSubStr(String str1, int l, int h) {
        System.out.println(str1.substring(l, h + 1));
    }

    private static int longPalSubstr(String str1) {
        int n = str1.length();
