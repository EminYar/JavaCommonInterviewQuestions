...
// swaps them, continues doing (compares and swaps) for the next pair of adjacent elements.
// It then starts again with the first two elements, compares, swaps until no more swaps are required.
